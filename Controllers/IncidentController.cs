...
namespace SRM.Controllers
{
    public class IncidentController : BaseController
    {
        ...
        public ActionResult LogNewIncident()
        {
            ...
            // 1. Filter Incident Categories by Session Program
            ...
            // 2. Locations (Global)
            ViewBag.Locations = _db.IncidentLocations.OrderBy(x => x.LocationName).ToList();
            // ADD THIS: Fetch groups to populate the dropdown
            ViewBag.Groups = _db.groups.OrderBy(x => x.gname).ToList();
